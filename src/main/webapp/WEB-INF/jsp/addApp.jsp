...
<html>
    <head>
        ...
        <title>Đăng kí thông tin ứng dụng  </title>
    </head>
    <body>
        <h1></h1>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="device_id">Tên thiet bị</label>  
  <div class="col-md-4">
  <input id="fn" name="device_id" type="text" placeholder="" class="form-control input-md" required="">
...
<!-- Text input-->
<div class="form-group">
    <label class="col-md-4 control-label" for="member_id">Số ID</label>  
  <div class="col-md-4">
  <input id="cmpny" name="member_id" type="text" placeholder="" class="form-control input-md" required="">
